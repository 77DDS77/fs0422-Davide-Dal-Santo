package com.davidedalsanto.lezione1.Lezione1;
...
public class Lezione1Application {
	...
	public static void conf1() {
		...
		//tutte e due da p1 ma istanze separate		
		System.out.println(p1); 
		System.out.println(p1_2); 
		
		//con costruttore e valori su application.properties
		Person p2 = ctx.getBean("p2", Person.class);
		
		System.out.println(p2);
		
		//con property nel bean xml perche sfrutta constructor della classe
		Person p3 = ctx.getBean("p3", Person.class);
		System.out.println(p3);
		
		//con bean che prende valore da un altro bean
	...
	public static void conf3() {
		...
		ctx.scan("com.davidedalsanto.lezione1.Lezione1.components");
		ctx.refresh();
