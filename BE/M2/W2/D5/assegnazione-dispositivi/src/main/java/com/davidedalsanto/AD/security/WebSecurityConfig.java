package com.davidedalsanto.AD.security;
...
import com.davidedalsanto.AD.security.user.UserDetailsServiceImpl;
...
/*
	...
	public SecurityFilterChain configure(HttpSecurity http) throws Exception {
		return http.csrf()
				...
				.hasRole("ADMIN")
				.antMatchers("/api/devices")
				.hasRole("USER")
				.antMatchers("/api/devices/{id}")
				.hasRole("USER")
				.anyRequest()
				.authenticated()
				.and()
