...
let range2 = durataMutuoAnni =>{
    return 2022 + durataMutuoAnni;
}
...
let range = anni =>{
    if(anni){
        ...
        if(anni >= 0 && anni <= 19){
            return 'Sei un teenager';
        }else if(anni >= 20 && anni <= 30){
            return 'Sei ancora giovane...credo';
        }else if(anni >= 31 && anni <= 50){
            return 'Ti sono vicino';
        }else if(anni >= 51 && anni <= 130){
...
console.log(range(28));

// function nesting

function loanCalc(loanYearDurat){
    return function(mensilities){
        return loanYearDurat * mensilities;
    }
}

console.log('Total mensilities : ' + loanCalc(20)(4));
